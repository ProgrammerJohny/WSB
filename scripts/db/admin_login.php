...
if(isset($_POST['submit'])) {
    try{
      $ins = "SELECT * FROM members WHERE member_login = :member_login AND member_password = :member_password";
        $sql =$conn->prepare($ins);
      $sql->bindParam(":member_login",$_POST['login'], PDO::PARAM_STR);
      $sql->bindParam(":member_password", $_POST['password'], PDO::PARAM_STR);
      $sql->execute();
      echo "Zalogowano poprawnie !<br /><a href='admin.php'>Przejdź dalej</a>";
    }
